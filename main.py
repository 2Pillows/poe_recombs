...
class Recombinate:
    ...
    def _item_probability(self, prefix_first=False, suffix_first=False):
        ...
        if prefix_first:
            ...
            if self.total_exclusive_prefixes > 0 and (
                self.total_desired_prefixes > 0 or self.total_exclusive_suffixes > 0
            ):
                required_prefixes += 1
        ...
        # if no exclusive suffixes, add exclusive prefix
            ...
            if self.total_exclusive_suffixes > 0 and (
                self.total_desired_suffixes > 0 or self.total_exclusive_prefixes > 0
            ):
                required_suffixes += 1
